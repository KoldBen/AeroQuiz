...
function UploadZone({ onUpload }) {
    ...
    }, [onUpload, numQuestions, comments]);
    ...
    const validateAndUpload = (file) => {
        ...
        if (validTypes.includes(file.type)) {
            onUpload(file, numQuestions, comments);
        } else {
    ...
    return (
        <div className="upload-container" style={{ maxWidth: '600px', margin: '0 auto' }}>
            <div className="glass-panel" style={{ marginBottom: '2rem', padding: '1.5rem' }}>
                ...
                <div style={{ marginBottom: '0.5rem' }}>
                    ...
                    <textarea
                        ...
                        placeholder="e.g. Focus on Chapter 3, make it difficult..."
                        value={comments}
